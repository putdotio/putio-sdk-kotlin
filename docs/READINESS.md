...
| Live verification | `medium` | account, auth, files/trash, history, and safe transfer read paths are live-covered; more namespace depth is still needed as the public surface grows |
