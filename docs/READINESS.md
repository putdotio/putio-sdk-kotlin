...
- the first-party Android consumer verifies minSdk 26 and an R8-minified release build through the composite SDK
...
| Android consumption | `good` | `putio-android` consumes the composite build at minSdk 26; its canonical gate assembles an unsigned, minified mobile release with no SDK-specific keep rules |
