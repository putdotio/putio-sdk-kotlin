...
| Release readiness | `good` | tag-driven Maven Central publishing through the Central Portal; first release pending the `io.put` namespace and signing credentials ([#43](https://github.com/putdotio/putio-sdk-kotlin/issues/43)) |
